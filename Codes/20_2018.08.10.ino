     ...
     if(CameraExist)
      {
       ...
       else if(pixy.blocks[0].x > 80 && pixy.blocks[0].x <= 140)   {move(100,45,-100); delay(3);}  //좌회전
       else if(pixy.blocks[0].x >= 175 && pixy.blocks[0].x <= 230)        {move(100,-50,-100); delay(3);}  //우회전
       else if(pixy.blocks[0].x > 230 )        {move(100,-80,-100); delay(3);}  //크게 우회전
